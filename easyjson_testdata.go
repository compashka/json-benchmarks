...
type NestedStructureEasyJson struct {
	ID       int                       `json:"id"`
	Name     string                    `json:"name"`
	Children []NestedStructureEasyJson `json:"children,omitempty"`
}

type TestData2EasyJson struct {
	StrField string
	IntField int
}

type TestData4EasyJson struct {
	StrField   string
	IntField   int
	FloatField float64
	BoolField  bool
...
type TestData12EasyJson struct {
	StrField   string
	IntField   int
	FloatField float64
	BoolField  bool
